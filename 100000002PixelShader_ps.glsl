	...
	***	[Hash 0x5cb4719a]	1
	***	[Hash 0x5dbe1dca]	1
	***	[Hash 0x5f6604e9]	1056964608
	***	[Hash 0x61caaa18]	0
	***	[Hash 0x61e63948]	1
	***	[Hash 0x62055e42]	4
	***	[Hash 0x66ac9d57]	0
	***	[Hash 0x66e44c23]	1726237731
	***	[Hash 0x67349ca6]	1059760811
	***	[Hash 0x67401cd5]	4
	***	[Hash 0x675280f4]	0
	***	[Hash 0x68b09743]	1
	***	[Hash 0x6962e498]	1
	...
	***	[Hash 0xb0e4cb8e]	0
	***	[Hash 0xb32b8837]	4
	***	[Hash 0xb3409907]	1065353216
	***	[Hash 0xb3a69a53]	1065353216
	***	[Hash 0xb5702d2a]	0
	***	[Hash 0xb7b857ae]	1
	***	[Hash 0xb9201184]	0
	***	[Hash 0xb953c16c]	1
	...
	***	[Hash 0xef99befe]	1059760811
	***	[Hash 0xf6eb512d]	0
	***	[Hash 0xf742ff75]	1
	***	[Hash 0xfdbd2de7]	1
	DONE DUMPING PROPERTIES
	***	[Hash 0x0a83e0b7]	1.000000
	***	[Hash 0x1fabb200]	0.000000
	***	[Hash 0x22ef0c67]	0.000000
	***	[Hash 0x2c2b0fc1]	>=
	***	[Hash 0x51bddb47]	0.666667
	***	[Hash 0x5f6604e9]	0.500000
	***	[Hash 0x61caaa18]	0.000000
	***	[Hash 0x67349ca6]	0.666667
	***	[Hash 0x77e205f3]	1.000000
	***	[Hash 0xb3409907]	1.000000
	***	[Hash 0xb3a69a53]	1.000000
	***	[Hash 0xc8f40d57]	0.500000
	***	[Hash 0xef99befe]	0.666667
	DONE DUMPING PIECES
#endif
...
vulkan_layout( location = 0 ) in block
{
	...
	vulkan_layout( ogre_T2 ) uniform usamplerBuffer f3dGrid;
	ReadOnlyBufferF( 1, float4, f3dLightList );




	vulkan_layout( ogre_t4 ) midf_tex uniform texture2DArray textureMaps0;
	...
	#define hlms_shadowmap0_uv_max float2( 1.000000, 0.666667 )
	
							#define hlms_shadowmap0_uv_param , hlms_shadowmap0_uv_min, hlms_shadowmap0_uv_max
			
	#define hlms_shadowmap1 texShadowMap0
	#define hlms_shadowmap1_uv_min float2( 0.000000, 0.666667 )
	#define hlms_shadowmap1_uv_max float2( 0.500000, 1.000000 )
	
							#define hlms_shadowmap1_uv_param , hlms_shadowmap1_uv_min, hlms_shadowmap1_uv_max
			
	#define hlms_shadowmap2 texShadowMap0
	#define hlms_shadowmap2_uv_min float2( 0.500000, 0.666667 )
	#define hlms_shadowmap2_uv_max float2( 1.000000, 1.000000 )
	...
	#define OGRE_SAMPLE_SHADOW_ESM( tex, sampler, uv ) textureLod( tex, uv, 0 ).x
		...
		INLINE midf getShadow( sampler2DShadow shadowMap, 
	   ...
	   ///! exponential_shadow_maps
		...
		INLINE midf getShadowPoint( sampler2DShadow shadowMap, 
...
void main()
{
	...
	pixelData.diffuse.xyz *= midf3_c( material.kD.xyz );
		...
		if( material.kD.w >= pixelData.diffuse.w )
			discard;
