...
namespace debug
{
    ...
    struct DebugHudSnapshot
    {
        ...
        std::uint16_t voxelRuntimeId=0,targetRuntimeId=0;
        bool voxelLoaded=false,targetPresent=false,targetSolid=false,targetOpaque=false,
             targetTransparent=false,flashlightEnabled=false;
    };
