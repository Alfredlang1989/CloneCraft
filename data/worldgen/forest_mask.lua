...
function sample(seed)
    ...
    local moist=smoothstep(0.45,0.70,r)
    local thermal=1.0-smoothstep(0.22,0.43,math.abs(t-0.52))
    local lowland=1.0-smoothstep(0.60,0.76,macro)
    return clamp(math.sqrt(moist*thermal)*lowland*0.82*land_factor(),0,1)
end
